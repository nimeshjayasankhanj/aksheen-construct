                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <button type="button" class="btn btn-md btn-outline-primary waves-effect float-right"
                                        data-toggle="modal"  data-target="#addBrandModal" style="border-radius: 24px">
                                    Add Brand</button>
                            </div>
                        </div>
                    </form>
                                            ...
                                            <td>{{$brand->created_at}}</td>
                                                ...
                                                @if($brand->status == 1)
                                                    ...
                                                    <td>
                                                        <p>
                                                            <input type="checkbox"
                                                                   onchange="adMethod('{{ $brand->idcategory}}','category')"
                                                                   id="{{"c".$brand->idcategory}}" checked
                                                                   switch="none"/>
                                                            <label for="{{"c".$brand->idcategory}}"
                                                                   data-on-label="On"
                                            ...
                                            <td>
                                                    ...
                                                    <p>
                                                        <button type="button"
                                                                ...
                                                                data-toggle="modal"
                                                                data-id="{{ $brand->idcategory}}"
                                                                data-name="{{$brand->category_name}}"
                                                                id="uBrandID"
...
@include('brand.add-brand-from')

<!-- edit category section -->
@include('brand.edit-brand-form')
...
<script type="text/javascript">
    ...
    //save brand
    $("#saveBrandId").on("submit", function (event) {
                $("#saveBrand").hide();
                $("#waitButton").show();
                $("#categryError").html('');
