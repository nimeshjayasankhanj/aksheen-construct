...
(function($) {
    ...
    $.sessionTimeout = function(options) {
        ...
        // Extend employee-set options over defaults
        if (options) {
        ...
        // Unless employee set his own callback function, prepare bootstrap modal elements and events
        ...
        function startCountdownTimer(type, reset) {
            ...
            if (type === 'dialog' && reset) {
                ...
                // (this is needed if employee doesn't close the warning dialog)
